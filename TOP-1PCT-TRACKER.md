...
- **Last shipped:** **C2** — cross-brand contamination fixed. Direct-API callers (Alliance etc.) now get their own brand, inventory, and support contacts. ✅ LIVE-VERIFIED ([#59](https://github.com/eazyapp-tech/claude-booking-bot/pull/59)).
- **Last shipped:** **H3** — "What did I shortlist?" now routes correctly to profile agent. 23/23 hermetic. ✅ ([#62](https://github.com/eazyapp-tech/claude-booking-bot/pull/62))
- **Doing next:** Alliance audit open issues — **M1** (Hindi input → English qualifying questions), M2 (qualify-vs-search threshold), M3 (fabricated commute prose). Full list: see Alliance Audit Issues table at bottom of Phase 1.
...
| Multi-brand | **C2** — cross-brand contamination: direct-API callers now resolve brand from API key, not OxOtel default. 19/19 hermetic. Also closes C1+C3+H4. Live-verified. | [#59](https://github.com/eazyapp-tech/claude-booking-bot/pull/59) [#61](https://github.com/eazyapp-tech/claude-booking-bot/pull/61) |
...
|---|---|---|---|---|---|
| **C2** | All Alliance users got OxOtel brand, properties, brand name | `resolve_web_brand` OxOtel default when no token | ✅ [#59](https://github.com/eazyapp-tech/claude-booking-bot/pull/59) [#61](https://github.com/eazyapp-tech/claude-booking-bot/pull/61) | H Rl Rf | ✅ |
| **H3** | "What did I shortlist?" → "trouble processing" | Supervisor doesn't route short returning queries to profile agent | ✅ [#62](https://github.com/eazyapp-tech/claude-booking-bot/pull/62) — PROFILE_PHRASES + supervisor prompt | H Gr | ✅ |
